...
OUT="/scratch/euh7ys/climate_xai/concept_ivt/footprint_340_family_8k.npz"
...
def save(nd): np.savez(OUT,nlat=NLAT,nlon=NLON,ndone=nd,cc=np.array(CC),**{f"cnt_{cc}":cnt[cc] for cc in CC})
