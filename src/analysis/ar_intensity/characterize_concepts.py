...
CONCEPTS = [int(x) for x in os.environ.get("CONCEPTS", "99,1454,3392,2722,194,3289,1829,3481,340,176").split(",")]
OUT = "/scratch/euh7ys/climate_xai/concept_ivt/characterize_final.npz"
